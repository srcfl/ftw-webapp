  ...
  <main>
    <section class="hero" aria-labelledby="page-title">
      <div>
        ...
        <p class="lede">GitHub reach, site visits, project work, relay load and anonymous fleet reports in one place.</p>
      </div>
    ...
    <section aria-labelledby="headline-title">
      <div class="section-head">
        <div><p class="eyebrow">NOW</p><h2 id="headline-title">Project signal</h2></div>
      </div>
